            ...
            >
              ...
              <div className="col-sm-6 col-lg-4 grid-item">
                <div className="card bg-light p-3">
                  <div className="card-body">
                    {/* Badge */}
                    <a href="#" className="badge bg-success text-white mb-2">
                      Research
                    </a>
                    {/* Title */}
                    <h5 className="card-title">
                    ...
                    <p>
                      ...
                      their list down to colleges that best fit their needs,
                      experts say. Yet remarkably appearance gets him his
                      projection.{" "}
                    </p>
                    {/* Info */}
                    <div className="d-flex justify-content-between">
              ...
              <div className="col-sm-6 col-lg-4 grid-item">
                <div className="card h-100">
                  ...
                  <div className="card-body px-3">
                    {/* badge */}
                    <a href="#" className="badge bg-purple text-white mb-2">
                      Travel
                    </a>
                    {/* Title */}
                    <h5 className="card-title">
              ...
              <div className="col-sm-6 col-lg-4 grid-item">
                <div className="card">
                  <div className="overflow-hidden rounded-3">
                    ...
                    <div className="card-img-overlay d-flex align-items-start p-3">
                      {/* badge */}
                      <a href="#" className="badge bg-warning text-white">
                        Lifestyle
                      </a>
                    </div>
                  </div>
              ...
              <div className="col-sm-6 col-lg-4 grid-item">
                ...
                >
                  <div className="card-body">
                    {/* Badge */}
                    <a href="#" className="badge bg-warning text-white mb-2">
                      Lifestyle
                    </a>
                    {/* Title */}
                    <h5 className="card-title text-primary-hover mb-1">
                    ...
                    <ul className="list-inline mb-0 mt-3">
                      <li className="list-inline-item text-white me-3 mb-1 mb-sm-0">
                        Aug 26, 2021
                      </li>
              ...
              <div className="col-sm-6 col-lg-4 grid-item">
                <div className="card h-100">
                  ...
                  <div className="card-img-top rounded overflow-hidden position-relative hover-overlay-top">
                    <div className="ratio ratio-16x9">
                      <iframe
                        src="video/167434033.html?title=0&byline=0&portrait=0"
                        width={620}
                        height={347}
                        allowFullScreen
                      />
                  ...
                  <div className="card-body px-3">
                    ...
                    {/* Title */}
                    <h5 className="card-title">
                      <a href="#">10 things you need to know about Eduport</a>
                    </h5>
                    <p className="text-truncate-2">
                      Prospective students should start broadly and then narrow
                      their list{" "}
              ...
              <div className="col-sm-6 col-lg-4 grid-item">
                <div className="card">
                  <div className="overflow-hidden rounded-3">
                    ...
                    <div className="card-img-overlay d-flex align-items-start p-3">
                      {/* badge */}
                      <a href="#" className="badge bg-primary text-white">
                        Sports
                      </a>
                    </div>
                  </div>
