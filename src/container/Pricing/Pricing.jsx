                  ...
                  <div className="card-header p-0">
                    ...
                    <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded-2">
                      ...
                      <div>
                        ...
                        <div className="badge bg-dark mb-0 rounded-pill">
                          Most popular
                        </div>
                      </div>
                      {/* Price */}
                      <div>
                        <h4
                          className="text-success mb-0 plan-price"
                  ...
                  <div className="card-header p-0">
                    ...
                    <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded-2">
                      ...
                      <div>
                        ...
                        <div className="badge bg-grad mb-0 rounded-pill">
                          Recommended
                        </div>
                      </div>
                      {/* Price */}
                  ...
                  <div className="card-header p-0">
                    ...
                    <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded-2">
                      ...
                      <div>
                        <h4
                          className="text-success mb-0 plan-price"
                          data-monthly-price="$99"
                          data-annual-price="$999"
                        >
                          $99
                        </h4>
                        <p className="small mb-0">/ per user</p>
              ...
              <div className="col-12">
                ...
                <div className="tiny-slider arrow-round">
                  ...
                  >
                    ...
                    <div className="item">
                      <img
                        src="assets/images/client/linkedin.svg"
                        className="grayscale"
                        alt
                      />{" "}
                    </div>
            ...
            <div className="row g-4 g-md-5">
              ...
              <div className="col-md-6">
                ...
                <p>
                  ...
                  asked. Paid mind even sons does he door no. Attended overcame
                  repeated it is perceived Marianne in. I think on style child
                  of. Servants moreover in sensible it ye possible.
                </p>
              </div>
              {/* FAQ item */}
              <div className="col-md-6">
                ...
                <p>
                  ...
                  Dejection assurance mrs led certainly So gate at no only none
                  open Betrayed at properly it of graceful on Dinner abroad am
                  depart ye turned hearts as me wished Therefore allowance too
                  perfectly gentleman supposing man his now Families goodness
                  all eat out bed steepest servants Explained the incommode sir
                  improving northward immediate eat Man denoting received you
                  sex possible you Shew park own loud son door less yet{" "}
                </p>
              </div>
              {/* FAQ item */}
              <div className="col-md-6">
              ...
              <div className="col-md-6">
                ...
                <p>
                  ...
                  sigh Extremely nor furniture fat questions now provision
                  incommode preserved Our side fail to find like now Discovered
                  traveling for insensible partiality unpleasing impossible she
                  Sudden up my excuse to suffer ladies though or Bachelor
                  possible Marianne directly confined relation as on he{" "}
                </p>
              </div>
              {/* FAQ item */}
              <div className="col-md-6">
                ...
                <p>
                  Preference any astonished unreserved Mrs. Prosperous
                  understood Middletons in conviction an uncommonly do.
                  Supposing so be resolving breakfast am or perfectly. Is drew
                  am hill from me. Valley by oh twenty direct me so. Departure
                  defective arranging rapturous did believe him all had
                  supported. Family months lasted simple set nature vulgar him.
                  Picture for attempt joy excited ten carried manners talking
                  how. Suspicion neglected he resolving agreement perceived at
                  an. Comfort reached gay perhaps chamber his six detract
                  besides add.
                </p>
              </div>
